 ...
 * @author cuent
 */
public class KardexFIFO implements Serializable {
    ...
    private Queue<Inventario> saldo;
    private List<SalidaKardex> salidas;

    public KardexFIFO() {
    }

    public KardexFIFO(Date fecha, String tipo, String detalle, int cantidad, double costo, double subtotal, Queue<Inventario> saldo, List<SalidaKardex> salidas) {
        this.fecha = fecha;
        this.tipo = tipo;
    ...
    public Queue<Inventario> getSaldo() {
        return saldo;
    }

    public void setSaldo(Queue<Inventario> saldo) {
        this.saldo = saldo;
    }
